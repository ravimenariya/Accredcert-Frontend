      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Stay informed with the latest insights on compliance, regulations,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="bg-white border border-gray-200 hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Guidelines and best practices for FDA registration and
                  compliance.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white border border-gray-200 hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600 text-sm">
                  International regulatory requirements and compliance
                  strategies.
                </p>
              </CardContent>
            </Card>
